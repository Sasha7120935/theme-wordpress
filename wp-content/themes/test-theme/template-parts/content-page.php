        ...
        <div class="wrapper page_text page_home">
                ...
                while ( $blog_query->have_posts() ) : $blog_query->the_post();
                    ...
                    <div class="introduction">
                        ...
                        <a class="button button_big button_orange float_left" href="<?php the_permalink(); ?>"><span
                                    class="inside"><?php echo esc_html__( 'Read more', 'text_domain' ) ?></span></a>
                    </div>
                <?php
                endwhile;
            endif;
                    ...
                    <li class="column column33">
                        <div>
                            ...
                            <div class="inside">
                                ...
                                <p><?php the_content() ?></p>
                                <p class="read_more"><a href="<?php the_permalink(); ?>"><?php echo esc_html__( 'Read more', 'text_domain' ) ?></a></p>
                            </div>
                        </div>
                    </li>
                <?php
            ...
            <div class="portfolio">
                ...
                foreach ( $categories as $category ) {
                    ?>
                    <p class="all_projects"><a href="<?php get_category_link($category->name) ?>"><?php echo esc_html__( 'View all projects', 'text_domain' ) ?></a></p>
                    <?php
                    break;
                }
                ?>
                <h1><?php echo esc_html__( 'Portfolio', 'text_domain' ) ?></h1>
                <div class="columns">
                    <?php
                    $args = [
                        'post_type' => 'portfolio',
