                ...
                <div class="columns">
                    ...
                    if ( $posts ):
                        while (the_repeater_field('gallery_image_setting', get_the_ID() ) ):
                            ...
                            <div class="column column50">
                                <div class="image">
                                    <img src="<?php echo get_sub_field('gallery__image_small', get_the_ID() ) ?>" alt="" />
                                    <p class="caption">
                                        ...
                                        <a href="<?php echo get_sub_field('gallery__image_big', get_the_ID() ) ?>" data-rel="prettyPhoto[gallery]" class="button button_small button_orange float_right lightbox"><span class="inside">zoom</span></a>
                                    </p>
                                </div>
                            </div>
                        <?php
